var productList = [
  ...
  var mains = document.getElementById("showcase");

var headtag = document.createElement("h2");
headtag.innerHTML = "Clothing for Men and Women";
headtag.className = "headcl";
mains.appendChild(headtag);

var clothsec =document.createElement("div");
clothsec.className="sec";

for (var i=0;i<productList.length;i++){
  if(productList[i].isAccessory===false){
    var clothcard=document.createElement("div");
    clothcard.className='card';
     
    var clothlink=document.createElement("a");
    clothlink.href="#";
    clothlink.className="cltlnkcl";
    clothcard.appendChild(clothlink);
    ...
    imgs1.className="image1cls";
    imgs1.src= productList[i].preview;
    imgdiv.appendChild(imgs1);

    var details1=document.createElement("div");
    details1.className="details";

    var prdt=document.createElement("h3");
    prdt.className='prdtcls';
    prdt.innerHTML=productList[i].name;

    var brnd=document.createElement("h4");
    brnd.className='brandcls';
    brnd.innerHTML=productList[i].brand;

    var prc=document.createElement("h5");
    prc.className='prcls';
    prc.innerHTML="Rs "+ productList[i].price;

    details1.appendChild(prdt);
    details1.appendChild(brnd);
    details1.appendChild(prc);
    clothlink.appendChild(imgdiv);
    clothlink.appendChild(details1);
    clothsec.appendChild(clothcard);
...
mains.appendChild(clothsec);



 var headtag2 = document.createElement("h2");
headtag2.innerHTML = "Accessories for Men and Women";
headtag2.clasName = "headcl";
headtag2.id="Accessories"
mains.appendChild(headtag2);

var accsec=document.createElement("div");
accsec.className ="sec";
for( var j=0; j<productList.length; j++){
  if(productList[j].isAccessory===true){
    var accard=document.createElement("div");
    accard.className="card";
     
    var acclink=document.createElement("a");
    acclink.href="#";
    acclink.className="acslnk";
    accard.appendChild(acclink);
    
    var imgdiv2 = document.createElement("div");
    imgdiv2.className = "img-div2";

    var imgs2=document.createElement("img");
    imgs2.className="image2cls";
    imgs2.src= productList[j].preview;
    imgdiv2.appendChild(imgs2);

    var details2= document.createElement("div");
    details2.className="details";

    var prod =document.createElement("h3");
    prod.className="prodcls";
    prod.innerHTML=productList[j].name

    var brd =document.createElement("h4");
    brd.className="brdcls";
    brd.innerHTML=productList[j].brand;

    var prs =document.createElement("h5");
    prs.className="brdcls";
    prs.innerHTML="Rs "+productList[j].price;

    details2.appendChild(prod);
    details2.appendChild(brd);
    details2.appendChild(prs);
    acclink.appendChild(imgdiv2);
    acclink.appendChild(details2);
    accsec.appendChild(accard);

  }
 }
 mains.appendChild(accsec)